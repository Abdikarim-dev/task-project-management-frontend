...
<html
    ...
    x-data="{
        ...
        async setTheme(value) {
            this.theme = value;
            if (window.persistTheme) {
                await window.persistTheme(value);
            }
        },
        toggleTheme() {
...
<body class="h-full font-sans">
    <div class="flex h-full min-h-screen bg-canvas">
        <div
            x-show="sidebarOpen"
        ...
        <aside
            ...
            class="fixed inset-y-0 left-0 z-50 w-64 transform border-r border-app bg-surface transition-transform duration-200 ease-in-out lg:static lg:translate-x-0"
        >
            <x-layout.sidebar />
        </aside>
